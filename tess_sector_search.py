...
class SectorSetup:
    ...
    def create_directory(self, spacecraft_ra, spacecraft_dec, spacecraft_roll):
        ...
        with open(config_file_path, "w") as file:
            ...
            file.write("[Field]\n")
            file.write("cameras=1,2,3,4\n")
            file.write("ca1_ccds=1,2,3,4\n")
            file.write("ca2_ccds=1,2,3,4\n")
            file.write("ca3_ccds=1,2,3,4\n")
            file.write("ca4_ccds=1,2,3,4\n")
            file.write("ncadences=1\n")
            file.write("ra0=%.3f\n" % float(spacecraft_ra))
