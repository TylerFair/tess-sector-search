...
class PBSScript:
    ...
    def __init__(self, sector, orbit, path='~/30daytemp/'):
        ...
        self.download_url = "https://archive.stsci.edu/hlsps/tica/s{sector:04d}/cam{cam}-ccd{ccd}/hlsp_tica_tess_ffi_s{sector:04d}-o{orbit_binary}-00[{start_cadence}-{end_cadence}]-cam{cam}-ccd{ccd}_tess_v01_img.fits"
